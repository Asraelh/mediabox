...
public interface IUsuarioRepository extends CrudRepository<Usuario, String> {
	...
	@Query(value="SELECT insertUser(:username,:pass,:email,:alias,:nombre,:apellidos)",nativeQuery=true)
	public boolean insertUser(@Param("username") String user, @Param("pass") String password, @Param("email")String email, @Param("alias")String alias, @Param("nombre")String nombre, @Param("apellidos")String apellidos);
